...
!!! info
    This page mirrors the project [`CHANGELOG.md`](https://github.com/Yamato-Security/takajo/blob/main/CHANGELOG.md). See the [Releases page](https://github.com/Yamato-Security/takajo/releases) for downloads.

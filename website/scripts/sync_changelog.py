...
NOTE_EN = (
    ...
    "[`CHANGELOG.md`](https://github.com/Yamato-Security/takajo/blob/main/CHANGELOG.md). "
    "See the [Releases page](https://github.com/Yamato-Security/takajo/releases) for downloads."
)
NOTE_JA = (
    '!!! info "情報"\n'
    "    このページはプロジェクトの "
    "[`CHANGELOG.md`](https://github.com/Yamato-Security/takajo/blob/main/CHANGELOG-Japanese.md) "
    "を反映したものです。ダウンロードは "
    "[リリースページ](https://github.com/Yamato-Security/takajo/releases) をご覧ください。"
)

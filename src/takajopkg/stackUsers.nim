...
const SYSTEM_ACCOUNTS = toHashSet([
    ...
    "NT-AUTORITÄT\\LOKALER DIENST", "NT-AUTORITÄT\\NETZWERKDIENST",
    "NT-AUTORITÄT\\SYSTEM", "VORDEFINIERT\\Administratoren",
    "AUTORITE NT\\SERVICE LOCAL", "AUTORITE NT\\SERVICE RÉSEAU",
    "AUTORITE NT\\SYSTEM", "BUILTIN\\Administrators",
    "NT AUTHORITY\\SERVIZIO LOCALE", "NT AUTHORITY\\SERVIZIO DI RETE",
    "NT AUTHORITY\\SYSTEM", "BUILTIN\\Administrators",
    "NT AUTHORITY\\SERVICIO LOC", "NT AUTHORITY\\SERVICIO DE RED",
    "NT AUTHORITY\\SYSTEM", "BUILTIN\\Administradores",
    "NT AUTHORITY\\LOCAL SERVICE", "NT AUTHORITY\\NETWORK SERVICE",
    "NT AUTHORITY\\СИСТЕМА", "BUILTIN\\Администраторы",
...
proc stackUsers(level: string = "informational", sourceUsers: bool = false,
    filterComputerAccounts: bool = true, filterSystemAccounts: bool = true,
